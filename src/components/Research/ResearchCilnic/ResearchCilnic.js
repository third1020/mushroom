    ...
    <MDBRow>
      <MDBCol md="4">
        <MDBCardBody>
          ...
          <center>
            <MDBBtn onClick={props.SearchResult("TRD")} color="primary" className="mt-4" rounded outline >Click</MDBBtn>
          </center>
      ...
      <MDBCol md="4">
        <MDBCardBody>
          ...
          <center>
            <MDBBtn onClick={props.SearchResult("Life-treatening Distress")} color="primary" className="mt-4" rounded outline >Click</MDBBtn>
          </center>
          <p className="mt-4 text-center">
      ...
      <MDBCol md="4">
        <MDBCardBody>
          ...
          <center>
            <MDBBtn onClick={props.SearchResult("GAD")} color="primary" className="mt-4" rounded outline >Click</MDBBtn>
          </center>
          <p className="mt-4 text-center">
...
และ/หรือ ภาวะวิตกกังวล (Generalized Anxiety Disorder: GAD)
      ...
      <MDBCol md="4">
        <MDBCardBody >
          ...
          <center>
            <MDBBtn onClick={props.SearchResult("OCD")} color="primary" className="mt-4" rounded outline >Click</MDBBtn>
          </center>
          <p className="mt-4 text-center">
      ...
      <MDBCol md="4">
        <MDBCardBody >
          ...
          <center>
            <MDBBtn onClick={props.SearchResult("Smoking Cessation")} color="primary" className="mt-4" rounded outline >Click</MDBBtn>
          </center>
          <p className="mt-4 text-center">
      ...
      <MDBCol md="4">
        <MDBCardBody >
          ...
          <center>
            <MDBBtn onClick={props.SearchResult("Other")} color="primary" className="mt-4" rounded outline >Click</MDBBtn>
          </center>
          <p className="mt-4 text-center">
            อื่นๆ (Other)
          </p>
      ...
      <MDBCol md="4">
        <MDBCardBody >
          ...
          <center>
            <MDBBtn onClick={props.SearchResult("Healthy Human")} color="primary" className="mt-4" rounded outline >Click</MDBBtn>
          </center>
          <p className="mt-4 text-center">
