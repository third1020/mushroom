  ...
  return (<div class="container">
    ...
    <section class="px-md-5 mx-md-5 dark-grey-text">
      ...
      <p className="lead mx-auto mb-5 mt-4">
        ซึ่ง ณ ปัจจุบัน ได้มีงานด้านวิจัยเชิงทดลองทางคลินิก (Clinical Trials) มากกว่า 37 ผลงานวิจัยเกี่ยวกับประสิทธิภาพในการรักษาโรคทางจิตเวชโดยใช้สารสกัดไซโลไซบิน (Psilocybin) ในปริมาณที่เหมาะสม
      </p>
